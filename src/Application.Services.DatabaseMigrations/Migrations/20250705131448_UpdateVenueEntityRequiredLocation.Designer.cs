...
namespace Application.Services.DatabaseMigrations.Migrations
{
    ...
    [Migration("20250705131448_UpdateVenueEntityRequiredLocation")]
    partial class UpdateVenueEntityRequiredLocation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Application.Domain.Entities.UserVenuePermissionEntity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_user_venue_permissions");

                    b.HasIndex("GrantedByUserId")
                        .HasDatabaseName("ix_user_venue_permissions_granted_by_user_id");
                    ...
                    b.HasIndex("VenueId", "Name", "IsActive")
                        .HasDatabaseName("IX_user_venue_permissions_venue_role_active");

                    b.ToTable("user_venue_permissions", (string)null);
                });
            ...
            modelBuilder.Entity("Application.Domain.Entities.UserVenuePermissionEntity", b =>
                {
                    b.HasOne("Application.Domain.Entities.UserEntity", "GrantedByUser")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_user_venue_permissions_users_granted_by_user_id");

                    b.HasOne("Application.Domain.Entities.UserEntity", "User")
                        .WithMany("VenuePermissions")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_user_venue_permissions_users_user_id");
                    ...
                    b.HasOne("Application.Domain.Entities.VenueEntity", "Venue")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_user_venue_permissions_venues_venue_id");
